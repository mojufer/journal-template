...
\setlength{\lineSpacing}{0.75em} % You can adjust this value to change the spacing
...
\section*{Pensées}
\notes[\lineSpacing]{7}{\textwidth}

% Sport of the Day Section
\section*{Sport}
\notes[\lineSpacing]{1}{\textwidth}
